...
def func(x, coeff):
    ...
    return 2*coeff[0]*(x-(1./(x**2)))*np.exp(coeff[1]*(x**2+(2/x)-3))-coeff[0]*(1-1./(x**3))


    #Mooney-Rivlin
    #return coeff[0]*coeff[1]*(x-(1./(x**2)))+coeff[0]*(1-coeff[1])*(1-(1./(x**3)))
...
def der_func(x, coeff):
    ...
    """
    #Veronda-Westmann
    return np.array([2*(x-(1./(x**2)))*np.exp(coeff[1]*(x**2+(2/x)-3))-(1-1./(x**3)),2*coeff[0]*(x-(1./(x**2)))*np.exp(coeff[1]*(x**2+(2/x)-3))*((x**2+(2/x)-3))]).reshape(1,-1)
    
    #Mooney-Rivlin
    #return np.array([coeff[1]*(x-(1./(x**2)))+(1-coeff[1])*(1-(1./(x**3))),coeff[0]*(x-(1./(x**2)))+coeff[0]*(1-(1./(x**3)))]).reshape(1,-1)
...
def der2_func(x, coeff):
    ...
    #Veronda-Westmann
    return np.array([
        0,2*(x-(1./(x**2)))*np.exp(coeff[1]*(x**2+(2/x)-3))*((x**2+(2/x)-3)),
        2*(x-(1./(x**2)))*np.exp(coeff[1]*(x**2+(2/x)-3))*((x**2+(2/x)-3)),
        2*coeff[0]*(x-(1./(x**2)))*np.exp(coeff[1]*(x**2+(2/x)-3))*((x**2+(2/x)-3)**2)
        ]).reshape(1, 2, 2)
